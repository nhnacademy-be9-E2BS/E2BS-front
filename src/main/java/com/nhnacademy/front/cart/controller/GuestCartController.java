...
public class GuestCartController {
	...
	public ResponseEntity<?> guestAddToCart(@Validated @RequestBody RequestAddCartItemsDTO requestDto, BindingResult bindingResult,
	...
	public ResponseEntity<?> deleteCartForCustomer(HttpSession httpSession) {
		String sessionId = httpSession.getId();
		// String sessionId = "guest-session-abc123";

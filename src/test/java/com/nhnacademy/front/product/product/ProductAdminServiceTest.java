...
// 			requestMeta.getProductStateId(), requestMeta.getPublisherId(), requestMeta.getProductTitle(),
// 			requestMeta.getProductContent(), requestMeta.getProductDescription(), requestMeta.getProductPublishedAt(),
// 			requestMeta.getProductIsbn(), requestMeta.getProductRegularPrice(), requestMeta.getProductSalePrice(),
// 			requestMeta.isProductPackageable(), requestMeta.getProductStock(), productImage,
// 			requestMeta.getTagIds(), requestMeta.getCategoryIds(), requestMeta.getContributorIds());
// 		when(productAdminAdaptor.postCreateProduct(requestMeta, productImage)).thenReturn(
...
//
// 		// then
// 		verify(productAdminAdaptor, times(1)).postCreateProduct(requestMeta, productImage);
// 	}
//
// 	@Test
...
// 		when(productAdminAdaptor.postCreateProduct(requestMeta, productImage)).thenReturn(responseEntity);
//
// 		// when & then
...
// 		RequestProductDTO request = new RequestProductDTO(requestMeta.getProductStateId(),
// 			requestMeta.getPublisherId(), requestMeta.getProductTitle(), requestMeta.getProductContent(),
// 			requestMeta.getProductDescription(), requestMeta.getProductPublishedAt(), requestMeta.getProductIsbn(),
// 			requestMeta.getProductRegularPrice(), requestMeta.getProductSalePrice(), requestMeta.isProductPackageable(),
// 			requestMeta.getProductStock(), productImage, requestMeta.getTagIds(), requestMeta.getCategoryIds(),
// 			requestMeta.getContributorIds());
// 		when(productAdminAdaptor.putUpdateProduct(1L, requestMeta, productImage)).thenReturn(responseEntity);
//
// 		// when
// 		productAdminService.updateProduct(1L, request);
//
// 		// then
// 		verify(productAdminAdaptor, times(1)).putUpdateProduct(1L, requestMeta, productImage);
// 	}
//
// 	@Test
...
// 			requestMeta.getTagIds(), requestMeta.getCategoryIds(), requestMeta.getContributorIds());
//
// 		when(productAdminAdaptor.putUpdateProduct(1L, requestMeta, productImage))

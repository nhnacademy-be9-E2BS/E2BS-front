...
class ContributorControllerTest {
	...
	void createContributorSuccess() throws Exception {
		mockMvc.perform(post("/admin/settings/contributors")
				.param("contributorName", "name1")
				.param("positionId", "1")
				.with(csrf()))
			.andExpect(status().is3xxRedirection())
			.andExpect(redirectedUrl("/admin/settings/contributors"));
	}
	...
	void updateContributorSuccess() throws Exception {
		mockMvc.perform(put("/admin/settings/contributors/1")
	...
	void getAllContributorsSuccess() throws Exception {
		...
		mockMvc.perform(get("/admin/settings/contributors"))
